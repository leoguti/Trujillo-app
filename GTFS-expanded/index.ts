 ...
 * GTFS generation script - Schedule-based with expanded trips
 * Filters routes with hash=* tag
 *
 * This version generates stop_times.txt with specific departure times
...
async function main() {
  ...
  try {
    ...
    console.log('\nNote: This version uses schedule-based stop_times.txt (no frequencies.txt)');
  } catch (error) {
